  ...
  <Svg width={1920} height={1080} viewBox="0 0 1920 1080">
    <Defs>
      ...
      <Pattern
        ...
        viewBox="0 0 382 92"
      >
        <Image width={382} height={92} xlinkHref="ComponentTMP_0-image3.png" />
      </Pattern>
      <Pattern
        id="g"
        preserveAspectRatio="xMidYMid slice"
        ...
        viewBox="0 0 700 316"
      >
        <Image width={700} height={316} xlinkHref="ComponentTMP_0-image.png" />
      </Pattern>
      <ClipPath id="i">
    ...
    <G id="h" className="a">
      <Rect className="q" width={1920} height={1080} />
      <G transform="translate(-1671 -314.215)">
        <G transform="translate(1671 314.215)">
          <Path
            className="b"
            d="M0,1081.37,1920,855.781V-.347H0Z"
      ...
      <G transform="translate(428 256)">
        <G transform="translate(702)">
          ...
          />
          <G className="x" transform="matrix(1, 0, 0, 1, -1130, -256)">
            <G className="d" transform="translate(1162 256)">
              <Rect className="u" width={416} height={590.99} rx={4} />
              <Rect
                className="v"
                x={0.5}
                y={0.5}
          ...
          <Text className="e" transform="translate(132 561.991)">
            <TSpan className="f" x={0} y={0}>
          ...
          <Line className="i" x2={336} transform="translate(72 526.993)" />
          <Rect
            className="j"
            width={199.304}
            height={48}
            transform="translate(128.696 439.487)"
          />
          <Text className="k" transform="translate(216 413.998)">
            <TSpan x={0} y={0}>
              {"OR"}
            </TSpan>
          </Text>
          <G transform="translate(64 278.89)">
            <G className="w" transform="matrix(1, 0, 0, 1, -1194, -534.89)">
              <Rect
                className="l"
                width={344}
                height={48}
                rx={4}
                transform="translate(1194 534.89)"
              />
            </G>
            <Text className="m" transform="translate(172 29)">
              <TSpan x={-19.093} y={0}>
                {"Log in"}
              </TSpan>
            </Text>
          </G>
          <G transform="translate(64 179.383)">
            <G className="n">
              <Rect className="u" width={344} height={48} rx={4} />
              <Rect
                className="v"
                x={0.5}
                y={0.5}
            ...
            <Text className="o" transform="translate(24 29)">
              <TSpan x={0} y={0}>
                {"Password"}
              </TSpan>
            </Text>
          </G>
          <G transform="translate(64 107.63)">
            <G className="n">
              <Rect className="u" width={344} height={48} rx={4} />
              <Rect
                className="v"
      ...
      <Path
        className="t"
        d="M0,116.926,474.848,92.469V-.347H0Z"
        transform="translate(442.667 164.347)"
      />
    </G>
  </Svg>
);
